...
const strings = {
  ru: {
    ...
    "landing.pricing_note":
      "Сайт-приглашение, видео для WhatsApp, учёт гостей и открытка — бесплатно, навсегда. Премиум за 990 сом нужен, когда гостей больше сотни: личное сообщение каждому в один тап и файл для типографии.",
    ...
    "premium.subtitle":
      "Разослать приглашение сотне гостей и не потерять вечер на поиск каждого в контактах. Плюс файл для типографии и приглашение без нашей надписи. Оплата в сомах.",
    ...
    "premium.pay_note":
      "Оставьте номер — напишем в WhatsApp, пришлём реквизиты mbank и включим тариф сразу после перевода. Обычно в течение часа.",
  ...
  ky: {
    ...
    "landing.pricing_note":
      "Чакыруу-сайт, WhatsApp үчүн видео, меймандарды эсептөө жана открытка — түбөлүккө акысыз. 990 сомдук Премиум меймандар жүздөн ашканда керек: ар бирине бир басууда жеке кабар жана басмакана үчүн файл.",
    ...
    "premium.subtitle":
      "Жүз мейманга чакыруу жөнөтүп, ар бирин контакттардан издеп кечиңизди коротпоңуз. Ошондой эле басмакана үчүн файл жана биздин жазуусуз чакыруу. Төлөм сом менен.",
    "premium.price_free": "0 сом",
    "premium.price_suffix": "сом / той",
    ...
    "premium.pay_note":
      "Номериңизди калтырыңыз — WhatsApp'ка жазып, mbank реквизиттерин жөнөтөбүз жана которуудан кийин тарифти дароо күйгүзөбүз. Көбүнчө бир сааттын ичинде.",
