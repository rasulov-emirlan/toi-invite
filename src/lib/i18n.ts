...
const strings = {
  ru: {
    ...
    "landing.pricing_title": "Само приглашение — бесплатно",
    ...
    "landing.pricing_note":
      "Сайт-приглашение, видео для WhatsApp, учёт гостей и открытка — бесплатно, навсегда. 490 сом снимают водяной знак и дают файл для типографии. 990 сом нужны, когда гостей больше сотни: личное сообщение каждому в один тап.",
    ...
    "premium.kicker": "ТАРИФЫ",
    "premium.title": "Тарифы для вашего тоя",
    "premium.subtitle":
      "490 сом — готовые файлы без водяного знака, включая A5 для типографии. 990 сом — разослать приглашение сотне гостей и не потерять вечер на поиск каждого в контактах. Оплата в сомах.",
    "premium.price_free": "0 сом",
    "premium.price_suffix": "сом / той",
    "premium.free_badge": "Бесплатно навсегда",
    "premium.popular": "Популярный",
    "premium.order": "Заказать",
    "premium.free_cta": "Создать бесплатно",
    "premium.pay_note":
      "Оставьте номер — напишем в WhatsApp, пришлём реквизиты mbank и включим тариф после перевода. Отвечаем в рабочее время.",
    "premium.back": "← На главную",
    "premium.pay_submit": "Перейти к оплате — Finik",
    "premium.pay_note_live":
      "Оплата через Finik — QR любого банка КР (mbank, О!Деньги, Bakai и др.). Премиум активируется автоматически сразу после оплаты.",
    ...
    "rsvps.board_write_locked": "Написать лично — 990 сом",
    ...
    "rsvps.board_upsell":
      "С тарифом «Той под контролем» каждому гостю с номером можно написать в WhatsApp в одно касание — без поиска по контактам.",
    ...
    "premium.examples_hint":
      "Все шесть дизайнов бесплатны. Нажмите на любой, чтобы открыть его целиком.",
  ...
  ky: {
    ...
    "landing.pricing_title": "Чакыруунун өзү — акысыз",
    ...
    "landing.pricing_note":
      "Чакыруу-сайт, WhatsApp үчүн видео, меймандарды эсептөө жана открытка — түбөлүккө акысыз. 490 сом суу белгисин алып салып, басмакана үчүн файл берет. 990 сом меймандар жүздөн ашканда керек: ар бирине бир басууда жеке кабар.",
    ...
    "premium.kicker": "ТАРИФТЕР",
    "premium.title": "Тойуңуз үчүн тарифтер",
    "premium.subtitle":
      "490 сом — суу белгисиз даяр файлдар, басмакана үчүн A5 менен кошо. 990 сом — жүз мейманга чакыруу жөнөтүп, ар бирин контакттардан издеп кечиңизди коротпоо. Төлөм сом менен.",
    "premium.price_free": "0 сом",
    "premium.price_suffix": "сом / той",
    "premium.free_badge": "Түбөлүккө акысыз",
    "premium.popular": "Популярдуу",
    "premium.order": "Буйрутма берүү",
    "premium.free_cta": "Акысыз түзүү",
    "premium.pay_note":
      "Номериңизди калтырыңыз — WhatsApp'ка жазып, mbank реквизиттерин жөнөтөбүз жана которуудан кийин тарифти күйгүзөбүз. Иш убагында жооп беребиз.",
    "premium.back": "← Башкы бетке",
    "premium.pay_submit": "Төлөмгө өтүү — Finik",
    "premium.pay_note_live":
      "Төлөм Finik аркылуу — КРдин каалаган банкынын QR коду (mbank, О!Деньги, Bakai ж.б.). Премиум төлөмдөн кийин дароо автоматтык түрдө иштейт.",
    ...
    "rsvps.board_write_locked": "Жеке жазуу — 990 сом",
    ...
    "rsvps.board_upsell":
      "«Той көзөмөлдө» тарифи менен номери бар ар бир мейманга WhatsApp'та бир эле басууда жазсаңыз болот — контакттардан издебей.",
    ...
    "premium.examples_hint":
      "Алты дизайндын баары акысыз. Толук көрүү үчүн каалаганын басыңыз.",
