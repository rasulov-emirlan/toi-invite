...
const strings = {
  ru: {
    ...
    "premium.subtitle":
      "Приглашение без нашей надписи, личная помощь в WhatsApp и всё для большого тоя. Выберите тариф — оплата в сомах или заявка в WhatsApp.",
  ...
  ky: {
    ...
    "premium.subtitle":
      "Биздин жазуусуз чакыруу, WhatsApp аркылуу жеке жардам жана чоң той үчүн баары. Тарифти тандаңыз — сом менен төлөө же WhatsApp аркылуу өтүнүч.",
    "premium.price_free": "0 сом",
    "premium.price_suffix": "сом / той",
