...
const strings = {
  ...
  ky: {
    ...
    "create.field_map_hint":
      "2GIS'те залды таап → «Бөлүшүү» → «Шилтемени көчүрүү» басып, ушул жерге коюңуз. Меймандар картаны бир басып ачышат.",
    ...
    "invite.rsvp_hint_choice": "Адегенде жогорудан жоопту тандаңыз",
    "invite.rsvp_hint_name": "Атыңызды жазыңыз — анан жөнөтсө болот",
    "invite.rsvp_closed": "Жооп кабыл алуу аяктады. Пландар өзгөрсө — уюштуруучуга кайрылыңыз.",
    ...
    "rsvps.board_add_hint": "Тизмени бүт коюп койсоңуз болот — ар бир ысым жаңы саптан.",
